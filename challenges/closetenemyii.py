'''
https://www.coderbyte.com/editor/guest:Closest%20Enemy%20II:Python
...
def ClosestEnemyII(strArr):
    ...
    for x, y in enemies:
        possibleRoutes.append(abs(yourPos[0] - x) + abs(yourPos[1] - y))

    # return min(possibleRoutes)
    return yourPos, enemies, possibleRoutes
